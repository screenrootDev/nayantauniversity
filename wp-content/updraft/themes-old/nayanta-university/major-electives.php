<?php
/**
 * Template Name: MajorElectives
 */

get_header();

// Step 1: Get one post of type 'major-electives'
$args = [
    'post_type'      => 'major-electives',
    'orderby'        => 'ID',
    'order'          => 'ASC',
    'posts_per_page' => 1,
    'post_status'    => 'publish',
    ...
    while ($landing_query->have_posts()) : $landing_query->the_post();
        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <div class="container-fluid">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">major electives</li>
                </ol>
            </div>
        </nav>
        ...
        <section class="section section-admissions section-inner-hero">
            <div class="container">
                <div class="row gy-4">
                    <div class="col-12">
                        <?php if ($heading = get_field('major_electives_heading')) : ?>
                        ...
                        <div class="tabs-content-wrapper">
                            <div class="tabs-list">
                                <div class="tab-content-item active" tab-content-id="tab-undergraduate">
                                    ...
                                    if (have_rows('major_content')) {
                                        $i = 0;
                                        while (have_rows('major_content')) {
                                            the_row();
                                            $category = get_sub_field('category');
                                            $content = get_sub_field('major_electives_content');
