    ...
    <div class="container-fluid">
        ...
        <div class="footer-top">
            <div class="row gy-4">
                ...
                <div class="col-12 col-md">
                    <div class="footer-links">
                        <?php $careers_at_naynata_label = get_field_object('careers_at_naynata', 'option');
                        $careers_at_naynata_label = $careers_at_naynata_label['label'];

                        ?>
                        <div class="footer-title"><?php echo esc_attr($careers_at_naynata_label); ?></div>
                        <?php
                        $careers_at_naynata = get_field('careers_at_naynata', 'option');
                        if (!empty($careers_at_naynata) && is_array($careers_at_naynata)) :
                        ?>
                            <ul class="small-gap-links">
                                <?php foreach ($careers_at_naynata as $careers) :
                                    $text_icon = isset($careers['text_icon']) ? $careers['text_icon'] : '';
                                    $text_link = isset($careers['text_link']) ? $careers['text_link'] : '';
                                ?>
                                    <li>
                                        <span>
                                            <i class="<?php echo esc_attr($text_icon); ?>"></i>
                                            <a href="<?php echo esc_attr($text_link['url']); ?>" target="<?php echo esc_attr($text_link['target'] ?? '_self'); ?>"><?php echo esc_attr($text_link['title']); ?></a>
                                        </span>
                ...
                <div class="col-12 col-md-auto">
                    <div class="footer-links">
                        <div class="footer-title"><a href="/contact-us/" class="title-link"><?php esc_html_e('connect with us', 'nayanta'); ?></a></div>
...
<section class="cookies-box d-none" id="cookieConsent">
    <div class="container-fluid">
        <div class="cookies-inner">
            ...
            <div class="cookie-right btn-wrap">
                <button id="rejectCookies" class="btn btn-outline-black" type="button">
                    <?php esc_html_e('reject all', 'nayanta'); ?>
                </button>
                <button id="acceptCookies" class="btn btn-secondary" type="button">
                    <?php esc_html_e('accept', 'nayanta'); ?>
                </button>
            </div>
        </div>
